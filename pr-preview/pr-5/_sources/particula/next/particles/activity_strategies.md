...
- [Activity Strategies](#activity-strategies)
  - [ActivityStrategy](#activitystrategy)
    - [ActivityStrategy().activity](#activitystrategy()activity)
    - [ActivityStrategy().partial_pressure](#activitystrategy()partial_pressure)
  - [IdealActivityMass](#idealactivitymass)
    - [IdealActivityMass().activity](#idealactivitymass()activity)
  - [IdealActivityMolar](#idealactivitymolar)
    - [IdealActivityMolar().activity](#idealactivitymolar()activity)
  - [KappaParameterActivity](#kappaparameteractivity)
    - [KappaParameterActivity().activity](#kappaparameteractivity()activity)
