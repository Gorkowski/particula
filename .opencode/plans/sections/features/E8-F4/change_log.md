...
| Date | Change | Author |
|------|--------|--------|
| 2026-09-03 | P5 (issue #1571) was blocked at its prerequisite gate: E8-F4-P1--P4 native CUDA capture/replay is absent. No implementation, tests, or user documentation changed. | plan-update-full |
